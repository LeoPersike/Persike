/************************************************************
* Arquivo Functions.c - Exercicio lista duplamente encadeada generica
*
...
void insere_retangulo(float x1,float y1,float x2,float y2,float corR,float corG,float corB,float thick,ListaGen** Lista) // Insere um retangulo na lista
{
    ...
    novo->info = retnovo;
    novo->prox = *Lista;
    // Elemento anterior ao novo sempre sera NULL
    novo->ant = NULL;
    // Verifica se não é o primeiro da lista
    // Se nao for, faz o proximo apontar para o anterior
    if(*Lista != NULL)
        (*Lista)->ant = novo;
